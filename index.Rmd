...
if(PDF_EXPORT){
  ...
  cat("[<i class='fas fa-download'></i>¿Descargar el PDF de este CV?(https://github.com/nstrayer/cv/raw/master/strayer_cv.pdf)"
  
 ## (https://github.com/patriloto/CVLoto/raw/master/Loto_cv.pdf)
}
```
...
- <i class="fa fa-envelope"></i> andrea2882@gmail.com
- <i class="fa fa-twitter"></i> @patriloto
- <i class="fa fa-github"></i> github.com/patriloto 
...
Hecho con... {#disclaimer}
--------------------------------------------------------------------------------

Hecho con  el R paquete [**pagedown**](https://github.com/rstudio/pagedown). 

El código fuente source está disponible aquí [github.com/patriloto/cv](https://github.com/patriloto/cvLoto).

La última actualización fue hecha el `r Sys.Date()`.
...
Experiencia en la Industria {data-icon=suitcase}
--------------------------------------------------------------------------------
...
Experiencia en la enseñanza {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------
...
Publicaciones seleccionadas, Pósters, y Charlas {data-icon=book}
--------------------------------------------------------------------------------
